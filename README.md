...
![image-20251203085750095](images.assets/image-20251203085750095.png)

![image-20251201131714412](images.assets/image-20251201131714412.png)

![image-20251203085718874](images.assets/image-20251203085718874.png)

![image-20251203085721718](images.assets/image-20251203085721718.png)

![image-20251203085747198](images.assets/image-20251203085727427.png)
...
- [ ] **智能推荐**：基于用户习惯推荐阅读时间
- [x] **数据导出**：支持导出为 JSON 格式，并可导入恢复数据
- [x] **阅读洞察**：显示阅读统计和习惯分析（完成率、拖延指数、7日趋势等）
- [ ] **快捷键**：添加键盘快捷键支持
